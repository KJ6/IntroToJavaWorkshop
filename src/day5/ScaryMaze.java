...
int color=-1;
		...
		if(-3660765==mouseColor){
			JOptionPane.showMessageDialog(null, "Congratulations, you won!");	// pop up a message to tell them they won
		}	
	}
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("monstersound.wav"));
